...
function addPhotographersToHTML(filter)
{
  photographers.forEach((photographer) =>
  {
    ...
    if(filter == "" || photographer.tags.includes(filter))
    {
      ...
      {
        tagsFiltered.innerHTML = `<a href="#" id="${photographer.name};${tag}" class="nav-filters" onclick="getFilter(this);">#${tag}</a>`; // Ajout HTML. ${tag} seul puisque string.
      });
    }
  });
}
...
//     return json; // [[PromiseResult]] passe de Undefined à Object
//   });
